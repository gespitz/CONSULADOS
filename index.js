...
<html>
<head>
	<title>Visa de Argentina</title>
</head>

<body>
	<div class="step current">
  <form action="/github.io/" accept-charset="UTF-8" method="get">
<input name="utf8" type="hidden" value="✓">
    <div class="current-question" id="current-question">
	
	<div class="question" data-debug-template-path="lib/smart_answer_flows/check-uk-visa/questions/what_passport_do_you_have.govspeak.erb">
        <h2 data-test="question">
         Cuál es tu nacionalidad según esta expresada en tu pasaporte o documento de viaje?
        </h2>
        <div class="question-body">

            <p class="hint">Si sos refugiado o no posees pasaporte o documento de viaje, señala la opción refugiado o apátrida.</p>
...
<option value="south-georgia-and-south-sandwich-islands">South Georgia and the South Sandwich Islands</option>
...
<option value="sao-tome-and-principe">São Tomé and Principe</option>
...
var nacionalidad = e.options[e.selectedIndex].text;		  
